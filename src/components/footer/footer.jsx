        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Building extraordinary solutions for the modern world. 
              Join thousands of users who trust our platform to transform their ideas into reality.
            </p>
            ...
            <div key={section.title}>
              ...
              <div className="md:hidden">
                <button
                  ...
                  className="flex items-center justify-between w-full text-left py-3 border-b border-gray-700"
                >
                  <h3 className="text-lg font-semibold">{section.title}</h3>
                  <svg
                    className={`w-5 h-5 transition-transform duration-300 ${
                      expandedSections[section.title] ? 'rotate-45' : 'rotate-0'
                    }`}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
